var app = angular.module("twitter-feeds", ['ngSanitize','$strap.directives'] , function($routeProvider, $locationProvider) {
...
{
    $scope.pageSize         = 5;               // Limit for pagination
    $scope.searchString     = "";
...
{
    $scope.currentVO        = $scope.$parent.$parent.$parent.column;        //
